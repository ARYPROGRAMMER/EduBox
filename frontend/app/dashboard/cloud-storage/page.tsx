        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-muted-foreground">Keep your files synchronized across all your cloud storage providers</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-xs text-muted-foreground">{syncStats.totalSize} total size</p>
              </CardContent>
            </Card>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button onClick={handleSync} disabled={syncInProgress} className="bg-sky-600 hover:bg-sky-700">
                  <RefreshCw className={`h-4 w-4 mr-2 ${syncInProgress ? "animate-spin" : ""}`} />
                  {syncInProgress ? "Syncing..." : "Sync All"}
                </Button>
              </div>
              <CardDescription>Manage your cloud storage connections and sync settings</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  return (
                    <div key={index} className="p-4 border rounded-lg">
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <Badge variant={provider.connected ? "default" : "secondary"} className={provider.connected ? "bg-green-600" : ""}>
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-xs text-muted-foreground">Last sync: {provider.lastSync}</span>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure how your files are synchronized</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <div className="text-sm font-medium">Auto-sync</div>
                  <div className="text-sm text-muted-foreground">Automatically sync files when changes are detected</div>
                </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <div className="text-sm text-muted-foreground">Allow syncing when not connected to WiFi</div>
                </div>
                <Switch />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <div className="text-sm text-muted-foreground">Reduce file sizes to save storage space</div>
                </div>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Latest file synchronization activity</CardDescription>
            </CardHeader>
            <CardContent>
                  ...
                  <div key={index} className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-muted-foreground">{activity.action} to {activity.provider}</p>
                      </div>
                    </div>
